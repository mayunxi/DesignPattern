...
![模板方法模式的结构图](https://upload-images.jianshu.io/upload_images/21440240-b8d9627ff3990cde.gif?imageMogr2/auto-orient/strip)
...
![出国留学手续设计程序的结构图](https://upload-images.jianshu.io/upload_images/21440240-199ec1172a45eaeb.gif?imageMogr2/auto-orient/strip)
...
![含钩子方法的模板方法模式的结构图](https://upload-images.jianshu.io/upload_images/21440240-009a70e72332dacb.gif?imageMogr2/auto-orient/strip)
...
<pre class="info-box">抽象方法1的实现被调用...
钩子方法1被重写...
抽象方法2的实现被调用...</pre>
